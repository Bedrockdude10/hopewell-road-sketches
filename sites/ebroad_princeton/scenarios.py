...
from src.geometry.treatments import (AddBikeLane, AddBikeLaneBollards,
    ...
    DesignState, LANE_WIDTH_SLACK_FT, LaneNarrowing, MarkedParking,
    MIN_BIKE_LANE_FT, osm_derived_baseline, ProtectDaylightZone,
...
def build_proposal_two_way_bike_lane(baseline: DesignState, model=None) -> DesignState:
    """A 10 ft two-way protected bike lane along the south kerb of both E Broad St legs.
